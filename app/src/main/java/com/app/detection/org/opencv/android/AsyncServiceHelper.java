package com.app.detection.org.opencv.android;

import java.io.File;
import java.util.StringTokenizer;

import com.app.detection.org.opencv.core.Core;
...
class AsyncServiceHelper
{
            ...
            final LoaderCallbackInterface Callback)
    {
        ...
        Intent intent = new Intent("com.app.detection.org.opencv.engine.BIND");
        intent.setPackage("com.app.detection.org.opencv.engine");
     ...
     */
    protected static final String OPEN_CV_SERVICE_URL = "market://details?id=com.app.detection.org.opencv.engine";
